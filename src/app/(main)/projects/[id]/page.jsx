  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content={`Archer Arquitectura | ${project.title}`}
          key="title"
        />
        <meta
          name="description"
          content={`Descubre ${project.title} y todos los proyectos en los que ha participado a lo largo de su trayectoria Archer Arquitectura, estudio de arquitectura ubicado en Madrid.`}
        />
